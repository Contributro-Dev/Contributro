...
function ProjectDetail() {
  ...
  // Load issues once project is available (powers both the Issues tab and the Project Health widget)
  useEffect(() => {
    if (!project) return
  ...
  const handleCreatePullRequest = () => {
    ...
    if (!owner) {
      alert("No GitHub repo linked to this project.");
      return;
    }
        ...
        <div className="project-detail-content">
          ...
          <div className="center-content">
                  ...
                  (
                    <div className='joined-btn-div'>
                      ...
                      <div className="create-pull-div">
                        <button className="create-pull-btn" onClick={handleCreatePullRequest}>
            ...
            <div className="tabs" >
              ...
              {/* Discussions tab — navigate to dedicated page */}
              {(isMember || isOwner) &&
                <div
                  className={`discussions-btn ${activeTab === "discussions" ? "tab-active" : ""}`}
                  onClick={() => navigate(`/projects/${id}/discussions`)}
                >
                  <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <div className="project-health-div">
                  ...
                  <div className="health-main">
                    ...
                    <div className="cell-2">
                      ...
                      <span className="cell-data">{issuesLoading ? "…" : issues.length}</span>
                    </div>
